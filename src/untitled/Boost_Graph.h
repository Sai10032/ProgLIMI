...
typedef property<node_id_t,int,property<is_monitor_t, bool, property<is_SDN_t, bool, property<is_virtual_t,bool,property<real_id_t,unsigned,property<order_t,double, property<parent_t,unsigned>>>>>>> Vproperty;

typedef property<edge_weight_t,int, property < edge_component_t, std::size_t ,property<link_index_t,unsigned,property<mark_t,bool> > > > Eproperty;
